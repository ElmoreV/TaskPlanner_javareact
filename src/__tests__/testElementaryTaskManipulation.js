...
import { insertTaskInstanceIntoTopic,removeTaskInstanceFromTopic,generateEmptyTask,deleteEntireTask } from '../ModifyTaskTopicAdgElements';
...
it('generateTask_should_work', () => {
    ...
    let expectedTasks =  [
        ...
        { name: "Badkamer", id: 2, topics: [1], topicViewIndices: [3], completed: false, thisWeek: true, repeated: false, scheduled: true, weekOrderIndex: 2 },
        { name: "Backup opruimen", id: 5, topics: [1], topicViewIndices: [2], completed: false, thisWeek: false, repeated: true, scheduled: false, weekOrderIndex: 0 },
        { name: "New Task 6!", id: 6, topics: [], topicViewIndices: [], completed: false, thisWeek: false, repeated: false, scheduled: false, 
        weekOrderIndex: 0 },

    ]
    let expectedTask = { name: "New Task 6!", id: 6, topics: [], topicViewIndices: [], completed: false, thisWeek: false, repeated: false, scheduled: false, 
    weekOrderIndex: 0 }
    //Act
...
it('insertTaskIntoTopic_should_work', () => {
    ...
    let expectedTasks =  [
        { name: "Fiets repareren", id: 0, topics: [12], topicViewIndices: [1], completed: true, thisWeek: false, repeated: false, scheduled: false, weekOrderIndex: 1 },
        { name: "Outer Wilds", id: 1, topics: [21, 1], topicViewIndices: [1, 1], completed: false, thisWeek: false, repeated: false, scheduled: false, weekOrderIndex: 0 },
        { name: "Badkamer", id: 2, topics: [1,21], topicViewIndices: [3,2], completed: false, thisWeek: true, repeated: false, scheduled: true, weekOrderIndex: 2 },
        { name: "Backup opruimen", id: 5, topics: [1], topicViewIndices: [2], completed: false, thisWeek: false, repeated: true, scheduled: false, weekOrderIndex: 0 },
      ]
...
it('insertTaskIntoTopicInFront_should_work', () => {
    ...
    let expectedTasks =  [
        { name: "Fiets repareren", id: 0, topics: [12], topicViewIndices: [1], completed: true, thisWeek: false, repeated: false, scheduled: false, weekOrderIndex: 1 },
        { name: "Outer Wilds", id: 1, topics: [21, 1], topicViewIndices: [2, 1], completed: false, thisWeek: false, repeated: false, scheduled: false, weekOrderIndex: 0 },
        { name: "Badkamer", id: 2, topics: [1,21], topicViewIndices: [3,1], completed: false, thisWeek: true, repeated: false, scheduled: true, weekOrderIndex: 2 },
        { name: "Backup opruimen", id: 5, topics: [1], topicViewIndices: [2], completed: false, thisWeek: false, repeated: true, scheduled: false, weekOrderIndex: 0 },
      ]
...
it('removeTaskFromTopic_should_work', () => {
    ...
    let expectedTasks =  [
        { name: "Fiets repareren", id: 0, topics: [12], topicViewIndices: [1], completed: true, thisWeek: false, repeated: false, scheduled: false, weekOrderIndex: 1 },
        { name: "Outer Wilds", id: 1, topics: [21, 1], topicViewIndices: [1, 1], completed: false, thisWeek: false, repeated: false, scheduled: false, weekOrderIndex: 0 },
        { name: "Badkamer", id: 2, topics: [], topicViewIndices: [], completed: false, thisWeek: true, repeated: false, scheduled: true, weekOrderIndex: 2 },
        { name: "Backup opruimen", id: 5, topics: [1], topicViewIndices: [2], completed: false, thisWeek: false, repeated: true, scheduled: false, weekOrderIndex: 0 },
      ]
