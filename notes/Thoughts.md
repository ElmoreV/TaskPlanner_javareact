...
### Static and changing actions and goals
...
Example:
"I want to buy a car" -> "I will look around for a car for 2 hours" -> "I need to go on the internet" -> "I will open my laptop" -> "I need to find my laptop" -> "I will walk around and search my laptop"

But also:
"I want to continuously improve" <- "I need to reflect on my systems and activities every week" <- "I want to remember what I do"
...
## What are ways to categorize tasks?
...
## How are tasks related to each other
...
1. Clear all completed items from the planned list
