...
- [ ] Need an easier way to show task/topic information (id/viewIndex/weekIndex) - 3m
...
- [ ] Text editing tends to slow down if you type more - 3m
...
- [ ] Ability to spawn follow-up tasks or subtask/necessary tasks on a task in the Weekly List from a task (Completing the task made another TODO) - 8m
...
- [ ] It doesn't show you that your file is changed and unsaved when you change something - 2m
